...
.map((ticket) => {
var {subject, department, location, category, subCategory, approval, status, approvedBy, assignedTo, remark, createdAt, _id:ticketID} = ticket
...
const {
    ...
    const {subject, department, location, category, subCategory, approval, 
      status, approvedBy, assignedTo, remark, createdAt, _id:ticketID} = ticket.ticket
